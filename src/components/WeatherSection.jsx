...
import { CloudSun, Droplets, Thermometer, Wind, CloudRain, ChevronRight, TrendingUp } from 'lucide-react'
  ...
  return (
    <section className="bg-white px-6 md:px-20 py-16">
      ...
      <div className="text-center mb-10">
        <div className="flex text-blue-600 font-semibold items-center justify-center gap-2 mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 bg-gray-50 rounded-3xl">
        {cardData.map((card, index) => (
          <div 
            key={index} 
            className={`relative overflow-hidden bg-linear-to-br ${card.gradient} rounded-4xl p-8 shadow-lg transition-transform hover:scale-[1.02] cursor-default`}
          >
            {/* Header Row */}
